    ...
    <div class="card registration-form-card col-6 bg-transparent border-0">
        ...
        <div class="card-body">
            ...
            <p class="card-text text-white my-2">
                Already have an account? <span class="ms-2"><a href="/login" class="btn bt-sm">Sign In</a></span>
            </p>
            <!-- Card Text -->

            <!-- Back Button To Landing Page -->
            <small class="text-white">
                <i class="fa fa-arrow-alt-circle-left"></i> <a href="/" class="btn btn-sm">Back</a>
            </small>
